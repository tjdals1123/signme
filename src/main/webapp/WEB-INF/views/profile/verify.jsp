          ...
          <div class="col-lg-6">
            <section class="panel">
              ...
              <div class="panel-body">
                <form role="form" id="verify" action="/profile/myinfomodify" method="get">
                  <div class="form-group">
                    <label for="yourpassword">Password</label>
                    <input type="password" class="form-control" id="yourpassword" placeholder="Password">
                  </div>
                  <button type="submit" class="btn btn-success btn-lg" id="chkbtn"><i class="icofont-checked"></i></button>
                </form>
...
<!-- javascripts -->
  ...
  <script src="/resources/js/fullcalendar.min.js"></script>
    ...
    $(document).ready(function() {
		...
		function checkPwd() {
			$.getJSON("/profileRest/verify/" + mno, function(data) {
		...
		$("#chkbtn").on("click", function(e) {
			...
			var inputpassword = $("#yourpassword").val();
