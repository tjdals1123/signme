...
<!--              			<button id="searchBtn">Search</button> -->
        ...
        <c:if test="${pageMaker.prev}">
          <li class="page-item disabled">
          	<a class="page-link" href="/sign/myWaitingList?mno=${login.mno}&page=${pageMaker.startPage -1}">
          		&laquo;
          	</a>
          </li>
        </c:if>
        <c:forEach begin="${pageMaker.startPage}"
        	...
        	<li class="page-item
        		<c:out value="${pageMaker.cri.page == idx ? 'active' : ''}" />">
        			<a class="page-link" href="/sign/myWaitingList?mno=${login.mno}&page=${idx}&searchType=${cri.searchType}&keyword=${cri.keyword}">${idx}</a></li>			
        </c:forEach>
          <c:if test="${pageMaker.next && pageMaker.endPage > 0}">
          <li class="page-item">
          	<a class="page-link" href="/sign/myWaitingList?mno=${login.mno}&page=${pageMaker.endPage +1}">
          		&raquo;
          	</a>
          </li>
          </c:if>
