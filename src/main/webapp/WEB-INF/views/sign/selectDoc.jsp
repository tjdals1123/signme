...
<!-- include (header, sidebar) end -->
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><strong><i class="icofont-folder-open"></i>양식 선택</strong></h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="">메인</a></li>
              <li><i class="icofont-letter"></i>문서</li>
              <li><i class="icofont-folder-open"></i>양식 선택</li>
            </ol>
          </div>
        </div>

        <div class="row">
                <a style="color: whitesmoke;" href="/sign/reportWrite">
          <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <div style="width: 100%; height: 240px;" class="info-box purple-bg">
              <br><br>
                  
                  <i class="icofont-tasks"></i>
                  <div class="count">보고서 양식</div>
                </div>
            </div>
            <!--/.info-box-->
                </a>
          ...
          <!--/.col-->
              ...
              <a style="color: whitesmoke;" href="/sign/documentWrite">
          <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <div style="width: 100%; height: 240px;" class="info-box orange-bg">
              <br><br>
                <i class="icofont-file-alt"></i>
              <div class="count">신청서 양식</div>
            </div>
            <!--/.info-box-->
          </div>
              </a>
