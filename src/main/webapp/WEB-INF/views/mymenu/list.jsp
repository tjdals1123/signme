            ...
            <section class="panel">
              <header class="panel-heading">
                내 정보 수정
							...
							<select class="form-control" onchange="location.href=this.value" id="mno"
								name="mno">
								<option value="/myboard/list">선택</option>
								<option value="/myboard/mget?mno=1">1</option>
								<option value="/myboard/mget?mno=2">2</option>
								<option value="/myboard/mget?mno=3">3</option>
							</select>
                ...
                <div class="form">
                  ...
                  <form class="form-validate form-horizontal " id="register_form" method="get" action="">
                   <input type="hidden" name="mno"></input>
                    <div class="form-group ">
                      <label for="membernum" class="control-label col-lg-1">사번 
                      <span class="required"></span></label>
                      <div class="col-lg-3">
                        <input class=" form-control"  name="mno" disabled />
                      </div>
                      <label for="membername" class="control-label col-lg-2 col-lg-offset-1">이름 <span
                          class="required"></span></label>
                      <div class="col-lg-3">
                        <input class=" form-control"  name="mname"   disabled />
                      </div>
                    </div>
                    <div class="form-group ">
                      <label for="pwd" class="control-label col-lg-1">비밀번호 <span class="required">*</span></label>
                      <div class="col-lg-3">
                        <input class=" form-control"  name="mpwd"   />
                      </div>
                    ...
                    <div class="form-group ">
                      ...
                      <div class="col-lg-6">
                        <input class="form-control"  name="memail"  />
                      </div>
                    </div>
                    <div class="form-group ">
                      <label for="hiredate" class="control-label col-lg-1">입사일 </label>
                      <div class="col-lg-6">
                        <input class="form-control"  name="hiredate" disabled />
                      </div>
                    </div>
                    <div class="form-group ">
                      ...
                      <label for="work" class="control-label col-lg-1 col-lg-offset-1">직무 <span
                          class="required"></span></label>
                      <div class="col-lg-2">
                        <input class="form-control" id="work" name="work" type="text" disabled />
                      </div>
                    </div>
                    <div class="form-group ">
                      <label for="phonenumber" class="control-label col-lg-1">연락처 <span class="required"></span></label>
                      <div class="col-lg-6">
                        <input class="form-control"  name="mpnum"  />
                      </div>
                    </div>
                    <div class="form-group ">
                      <label for="address" class="control-label col-lg-1">주소 </label>
                      <div class="col-lg-6">
                        <input class="form-control"  name="maddress"  />
                      </div>
                    </div>
                    <div class="form-group ">
                      <label for="hiredate" class="control-label col-lg-1">생년월일 </label>
                      <div class="col-lg-6">
                        <input class="form-control"  name="mbirth"  />
                      </div>
                    </div>
                    <div class="form-group ">
                    ...
                    <div class="form-group ">
                      ...
                      <label for="remainvac" class="control-label col-lg-1 col-lg-offset-1">휴가일수 <span
                          class="required"></span></label>
                      <div class="col-lg-2">
                        <input class="form-control"  name="vacarem"  disabled />
                      </div>
                    </div>
                    <div class="form-group">
